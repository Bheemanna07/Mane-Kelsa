...
class SeekerProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            nameTv = findViewById(R.id.name_seeker)
            mailTv = findViewById(R.id.mail_seeker)
            addressTv = findViewById(R.id.seeker_address)
            aadhaarTv = findViewById(R.id.seeker_aadhaar)
            cityTv = findViewById(R.id.seeker_city)
            mobileTv = findViewById(R.id.seeker_mobile)
            stateTv = findViewById(R.id.seeker_state)
            professionTv = findViewById(R.id.seeker_profile_profession)
            profileIv = findViewById(R.id.profile_image_seeker)
            ...
            profileIv?.setOnClickListener {
                val actop = ActivityOptionsCompat.makeSceneTransitionAnimation(
                    this@SeekerProfile, profileIv!!, ViewCompat.getTransitionName(profileIv!!) ?: ""
                )
                startActivity(Intent(this@SeekerProfile, PhotoActivity::class.java), actop.toBundle())
            }
        } catch (e: Exception) {
            e.printStackTrace()
        }
    ...
    override fun onBackPressed() {
        startActivity(Intent(this@SeekerProfile, SeekerMain::class.java))
        finish()
    }

    fun edit_seeker(v: View) {
        startActivity(Intent(this@SeekerProfile, EditSeeker::class.java))
    }
}
